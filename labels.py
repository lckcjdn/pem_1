...
#     Label(      's_w_s' ,     7 ,     7 ,   'stopping' ,      3 ,      False ,      False , (220, 220,   0) ),
#     Label(      's_w_c' ,     8 ,     8 ,    'chevron' ,      4 ,      False ,      False , (102, 102, 156) ),
#     Label(      's_y_c' ,     9 ,     8 ,    'chevron' ,      4 ,      False ,      False , (128,   0,   0) ),
#     Label(      's_w_p' ,    10 ,     9 ,    'parking' ,      5 ,      False ,      False , (128,  64, 128) ),
#     Label(      'c_wy_z' ,   11 ,    10 ,      'zebra' ,      6 ,      False ,      False , (190, 153, 153) ),
#     Label(       'a_w_u',    12 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (  0,   0, 230) ),
#     Label(       'a_w_t',    13 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (128, 128,   0) ),
#     Label(      'a_w_tl',    14 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (128,  78, 160) ),
#     Label(      'a_w_tr',    15 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (150, 100, 100) ),
#     Label(       'a_w_l',    16 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (180, 165, 180) ),
#     Label(       'a_w_r',    17 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (107, 142,  35) ),
#     Label(      'a_n_lu',    18 ,    11 ,  'thru/turn' ,      7 ,      False ,      False , (  0, 191, 255) ),
#     Label(      'b_n_sr',    19 ,    12 ,  'reduction' ,      8 ,      False ,      False , (255, 128,   0) ),
#     Label(     'd_wy_za',    20 ,    13 ,  'attention' ,      9 ,      False ,      False , (  0, 255, 255) ),
#     Label(      'r_wy_np',   21 ,    14 , 'no parking' ,     10 ,      False ,      False , (178, 132, 190) ),
#     Label(     'vom_wy_n',   22 ,    15 ,     'others' ,     11 ,      False ,      False , (128, 128,  64) ),
#     Label(       'om_n_n',   23 ,    15 ,     'others' ,     11 ,      False ,      False , (102,   0, 204) ),
# ]
labels = [
    #           name          id  trainId      category     catId hasInstances ignoreInEval      color
    Label( 'background' ,     0 ,     0 ,       'void' ,      0 ,      False ,      True , (  0,   0,   0) ),
